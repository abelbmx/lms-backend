                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" id="archivosTabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="linked-tab" data-bs-toggle="tab" data-bs-target="#linked" type="button" role="tab" aria-controls="linked" aria-selected="false">Archivos Enlazados</button>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="archivosTabsContent">
                        ...
                        <!-- Linked Files Tab -->
                        <div class="tab-pane fade show active" id="linked" role="tabpanel" aria-labelledby="linked-tab">
                            <div class="mt-3">
