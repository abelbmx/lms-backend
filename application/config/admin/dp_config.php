...
$config['title']      = 'Stanley Black & Decker';
$config['title_mini'] = 'SB&D';
$config['title_lg']   = 'SB&D';
...
/* Breadcrumbs */
$config['breadcrumb_open']     = '<ol id="siteBreadcrumb" class="breadcrumb align-items-center" >';
...
$config['breadcrumb_el_last']  = '<li class="active text-muted fw-bold">';
